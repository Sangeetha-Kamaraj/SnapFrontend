...
const CreatePin = ({ user }) => {
  ...
  const uploadImage = (e) => {
    ...
    if (
      ...
      axios
        .post("https://snap-backend-z20x.onrender.com/api/v1/user/uploadimage", formData, config)
        .then((res) => {
          setLoading(false);
  ...
  const deleteUploaded = () => {
    ...
    axios
      .post(
        "https://snap-backend-z20x.onrender.com/api/v1/user/deleteuploaded",
        { url: imageAsset },
        config
      )
      .then((res) => {
  ...
  const savePin = () => {
    ...
    if (title && about && imageAsset && category) {
      ...
      axios
        .post("https://snap-backend-z20x.onrender.com/api/v1/user/newpin", data, config)
        .then((res) => {
          setIsLoading(false);
