...
const UserProfile = () => {
  ...
  useEffect(() => {
    axios
      .get("https://snap-backend-z20x.onrender.com/api/v1/user/user", config)
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(`https://snap-backend-z20x.onrender.com/api/v1/user/viewuser/${userId}`, config)
      .then((res) => {
  ...
  useEffect(() => {
    if (text === "Created") {
      setLoading(true);
      axios
        .get(`https://snap-backend-z20x.onrender.com/api/v1/user/createdpins/${userId}`, config)
        .then((res) => {
      ...
      setLoading(true);
      axios
        .get(`https://snap-backend-z20x.onrender.com/api/v1/user/savedpins/${userId}`, config)
        .then((res) => {
