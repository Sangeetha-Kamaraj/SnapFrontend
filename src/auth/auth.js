...
export const signup = (user) => {
  ...
  return axios
    .post("https://snap-backend-z20x.onrender.com/api/v1/register", {
      registerType,
      name,
      email,
      userId,
...
export const signin = (email, password) => {
  return axios
    .post("https://snap-backend-z20x.onrender.com/api/v1/login", { email, password })
    .then(async (res) => {
      saveToken(res.data.token);
      return {
        valid: true,
...
export const socialSignin = (type, userId, accessToken) => {
  return axios
    .post("https://snap-backend-z20x.onrender.com/api/v1/sociallogin", {
      type,
      userId,
      accessToken,
    })
